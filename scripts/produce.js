...
async function main() {
	...
	const argPath = process.env.argPath?.trim().toLowerCase();
  	const SalesFactoryAddress = process.env.SalesFactoryAddress?.trim().toLowerCase();
	...
	const SalesFactory = SalesFactoryF.attach(SalesFactoryAddress);
	//---
